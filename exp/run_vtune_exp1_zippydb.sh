...
RESULT_DIR="/ssd1/songxin8/thesis/rocksdb/vtune/exp1_64GBDIMMs/" 
...
run_zippydb () { 
  ...
  VTUNE_UARCH_COMMON="/opt/intel/oneapi/vtune/latest/bin64/vtune -collect uarch-exploration -start-paused \
      ...
      -data-limit=10000 -result-dir ${OUTFILE}_uarch \
      --app-working-dir=/ssd1/songxin8/thesis/rocksdb/rocksdb/"
  ...
  /opt/intel/oneapi/vtune/latest/bin64/vtune -command resume -r ${OUTFILE}_hotspot
  ...
  echo "[INFO] Warmup complete. Resuming Vtune profiling."
  /opt/intel/oneapi/vtune/latest/bin64/vtune -command resume -r ${OUTFILE}_memacc
  ...
  echo "[INFO] Warmup complete. Resuming Vtune profiling."
  /opt/intel/oneapi/vtune/latest/bin64/vtune -command resume -r ${OUTFILE}_uarch
